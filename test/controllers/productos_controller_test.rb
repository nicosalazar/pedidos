...
class ProductosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post productos_url, params: { producto: { id_categoria: @producto.id_categoria, nombre: @producto.nombre, unidad_medida: @producto.unidad_medida } }
    end
  ...
  test "should update producto" do
    patch producto_url(@producto), params: { producto: { id_categoria: @producto.id_categoria, nombre: @producto.nombre, unidad_medida: @producto.unidad_medida } }
